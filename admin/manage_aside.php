                              ...
                              <tbody>
                                <tr>
                                    <?php
                                        ...
                                        $result = mysqli_query($conn, $query);
                                        while ($row=mysqli_fetch_assoc($result)) {
                                            echo "<th scope='row'>{$row['aside_id']}</th>";
                                            echo "<td>{$row['aside_name']}</td>";
                                            echo "<td>{$row['aside_number']}</td>";
                                            echo "<td>{$row['aside_price_hour']}</td>";
                                            echo "<td>{$row['pitch_name']}</td>";
                                            echo "<td><a href='edit_aside.php?aside_id={$row['aside_id']}&pitch_id={$row['pitch_id']}' class='badge badge-complete bg-warning'>Edit</a></td>";
                                            echo "<td><a href='delete_aside.php?aside_id={$row['aside_id']}' class='badge badge-complete bg-danger'>Delete</a></td>";
                                            echo "<tr>";
