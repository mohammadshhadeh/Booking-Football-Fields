                            ...
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php
                                     ...
                                     echo  "<tr>
                                                <td> {$row['name']} </td>
                                                <td><span></span> {$row['phone']}</td>
                                                <td><span>{$row['identical_number']}</span> </td>
                                    ...
                                    echo "<td><a class='badge btn-lg btn-danger p-2' href='delete_booking.php?booking_id={$row['booking_id']}' class='text-white'>Delete</a></td>
                                            </tr>";
                                            }
                                        ?>
                                </tbody>
