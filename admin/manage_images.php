							...
							<table class="table">
								...
								<tbody>
									<?php
										...
										while ($row=mysqli_fetch_assoc($result)) : ?>
											<tr>
												<th scope='row'><?php echo $row['image_id']?></th>
												<th scope="row"><img height="100" width="100" src="upload/<?php echo $row['aside_image']; ?>"></th>
												<td><?php echo $row['aside_name'];?></td>
												<td><?php echo $row['aside_number'];?></td>
												<td><?php echo $row['pitch_name'];?></td>
												<td><a href="edit_images.php?image_id=<?php echo $row['image_id'] . '&pitch_id=' . $row['pitch_id'] . '&aside_id=' . $row['aside_id'] . '&aside_number=' . $row['aside_number'] . '&aside_name=' . $row['aside_name'] ?>"  class="btn badge-complete text-white bg-warning">Edit</a></td>
												<td><a href='delete_images.php?aside_id=<?php echo $row['image_id'];?>' class='badge badge-complete text-white bg-danger'>Delete</a></td>
											<tr>
										<?php endwhile;
									?>
							</tbody>
