			...
			<div class="row">
				<div class="col-md-6 col-xs-12 banner_details text-center">
					<div class="banner_hello" >Hello
						<span>
							<?php
								$name = isset($_SESSION['customer_id']) ? $row['name'] : "GHOSTIE !";
								echo $name;
							?>
						</span>
					</div>
				...
				<div class="col-md-6 col-xs-6 banner_icons animated rollIn">
                    ...
                    <div class="tab-content">
                        <div id="individuals-join-web" class="tab-pane fade">
                            <div class="pane_content">
                                ...
                                <div class="pane_content_right" style="background-image: url();">
                                    <div class="pane_content_header">
                                        <span>INDIVIDUALS</span><br />
                                        Join a Game
                                    </div>
                                    <div class="pane_content_footer">
                                        <div class="pane_content_footer_title">Itching to play?</div>
                                        <div class="pane_content_footer_desc">
                                            Alone or a small group of friends? Keen to play? Its simple. Choose from any number of friendly games happening all over Singapore. Book your slot(s). Turn up. Play!
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pane_content">
                                ...
                                <div class="pane_content_right" style="background-image: url();">
                                    ...
                                    <div class="pane_content_footer">
                                        ...
                                        <div class="pane_content_footer_desc">
                                            Tired of chasing your players, booking a pitch, collecting cash? Set up your game on Ghost Football. We do it all. Just show up and host. Short of players? We can top up too.
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="juniors-join-web" class="tab-pane fade">
                            <div class="pane_content">
                                ...
                                <div class="pane_content_right" style="background-image: url();">
                                    <div class="pane_content_header">
                                        <span>JUNIORS (9-16 YEARS)</span><br />
                                        Join a Game
                                    </div>
                                    <div class="pane_content_footer">
                            ...
                            <div class="pane_content">
                                ...
                                <div class="pane_content_right" style="background-image: url();">
                                    ...
                                    <div class="pane_content_footer">
                                        ...
                                        <div class="pane_content_footer_desc">
                                            Traditional academies are great, but can be costly and rigid. Sometimes a kid just wants to PLAY. No coaches here! Just gently facilitated games. And tremendous value. Enjoy a 3-month package,
                                            with 12 sessions, at just $120 (usual $160)!
                                        </div>
                                    </div>
                                </div>
                            </div>
					...
					<?php
						...
						while ($row=mysqli_fetch_assoc($result)) : ?>
							<div class='promo_item' >
								<a href='pitch.php?pitch_id=<?php echo $row['pitch_id']?>' >
									<div class='image_section' >
										<img src='images/blank.png' style='background-image:url(../admin/upload/<?php echo $row['pitch_image']?>' />
									</div>
									<div class='desc_section' >
										<div class='promo_desc_title' ><?php echo $row['pitch_name']?></div>
										<div class='promo_description' ><?php echo $row['description']?></div>
									</div>
