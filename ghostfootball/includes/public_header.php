				...
				<ul class="nav navbar-nav navbar-right">
					...
					<?php
						if (isset($_SESSION['customer_id'])) :
							...
							$row   = mysqli_fetch_assoc($result); ?>
							<li class='dropdown'>
								<a href='' class='user-logon' type='button' data-toggle='dropdown' aria-expanded='false'><?php echo $row['name']; ?> <img src='upload/<?php echo $row['profile_image']?>'></a>  
						...
						<?php else: ?>
							<li><a href="#sign_up_form" class="menu_popup" >Sign up</a></li>
